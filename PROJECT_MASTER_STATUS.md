...
- Before rerun, inspect the failed `employee_attendance_sessions` migration state and only remove the partial table if it exists and has zero rows. QAS only; Production unchanged.
