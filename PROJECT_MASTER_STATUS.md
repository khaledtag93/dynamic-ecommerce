...
- These admin changes have **not** been visually verified in QAS or deployed to Production. Their exact commit/CI evidence is recorded in the [documentation ledger](docs/README.md) after CI.
