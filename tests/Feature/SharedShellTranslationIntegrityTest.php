...
class SharedShellTranslationIntegrityTest extends TestCase
{
    public function test_shared_shell_translation_keys_exist_in_english_and_arabic(): void
    {
        $paths = [
            ...
            resource_path('views/admin/growth/operations.blade.php'),
            resource_path('resources/views/admin/growth/content.blade.php'),
            resource_path('resources/views/admin/growth/index.blade.php'),
            resource_path('resources/views/admin/growth/layout.blade.php'),
            resource_path('views/admin/growth/insights.blade.php'),
            resource_path('resources/views/components/admin/growth-validation-summary.blade.php'),
            resource_path('resources/views/admin/growth/campaign-form.blade.php'),
            resource_path('resources/views/admin/growth/rule-form.blade.php'),
            resource_path('resources/views/admin/growth/segment-form.blade.php'),
            resource_path('resources/views/admin/growth/template-form.blade.php'),
            resource_path('resources/views/admin/growth/experiment-form.blade.php'),
            ...
            resource_path('views/admin/imports/_results.blade.php'),
            resource_path('views/admin/notifications/index.blade.php'),
            resource_path('views/admin/notifications/inbox_fresh.blade.php'),
            resource_path('views/admin/notifications/standalone_plain.blade.php'),
        ];
