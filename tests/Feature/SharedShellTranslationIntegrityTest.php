...
class SharedShellTranslationIntegrityTest extends TestCase
{
    public function test_shared_shell_translation_keys_exist_in_english_and_arabic(): void
    {
        $paths = [
            ...
            resource_path('views/admin/growth/content.blade.php'),
            resource_path('views/admin/growth/index.blade.php'),
            resource_path('views/admin/growth/layout.blade.php'),
            resource_path('views/admin/growth/insights.blade.php'),
            resource_path('views/components/admin/growth-validation-summary.blade.php'),
