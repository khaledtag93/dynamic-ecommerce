...
class AuthorizationService
{
    public function permissions(): array
    {
        return [
            ...
            ['group' => 'support', 'slug' => 'support.view', 'name' => 'View support cases', 'description' => 'Review customer-service cases and their customer-visible timeline.'],
            ['group' => 'support', 'slug' => 'support.manage', 'name' => 'Manage support cases', 'description' => 'Create, assign, prioritize, reply to, resolve, and close customer-service cases.'],
