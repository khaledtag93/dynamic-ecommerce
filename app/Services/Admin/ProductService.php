...
class ProductService
{
    ...
    protected function prepareProductPayload(array $data): array
    {
        return [
            ...
            'base_price' => filled($data['base_price'] ?? null) ? $data['base_price'] : null,
            'sale_price' => filled($data['sale_price'] ?? null) ? $data['sale_price'] : null,
            'quantity' => filled($data['quantity'] ?? null) ? (int) $data['quantity'] : 0,
            'stock_status' => $data['stock_status'] ?? 'in_stock',
            'low_stock_threshold' => filled($data['low_stock_threshold'] ?? null) ? (int) $data['low_stock_threshold'] : null,
