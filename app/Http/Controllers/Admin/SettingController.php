    ...
    private function themePresets(): array
    {
        return [
            ...
            'royal_navy' => [
                ...
                'theme_label' => 'Royal Navy',
                'brand_primary_color' => '#1d4ed8',
                'brand_secondary_color' => '#172554',
                'brand_accent_color' => '#f59e0b',
                'brand_background_color' => '#f8fafc',
                'brand_surface_color' => '#ffffff',
                'brand_soft_color' => '#eff6ff',
                'brand_border_color' => '#cbd5e1',
                'brand_muted_bg_color' => '#f1f5f9',
                'brand_table_head_color' => '#eff6ff',
                'brand_row_hover_color' => '#f8fafc',
                'brand_button_text_color' => '#ffffff',
                'admin_sidebar_color' => '#172554',
                'admin_header_color' => '#ffffff',
                'admin_surface_color' => '#ffffff',
                'admin_card_border_color' => '#dbeafe',
                'admin_accent_soft_color' => '#fffbeb',
                'admin_primary_soft_color' => '#dbeafe',
                'customer_card_radius' => '16',
                'customer_badge_style' => 'outline',
            ],
            'emerald_studio' => [
                'theme_preset' => 'emerald_studio',
                'theme_label' => 'Emerald Studio',
                'brand_primary_color' => '#047857',
                'brand_secondary_color' => '#064e3b',
                'brand_accent_color' => '#d97706',
                'brand_background_color' => '#f8fafc',
                'brand_surface_color' => '#ffffff',
                'brand_soft_color' => '#ecfdf5',
                'brand_border_color' => '#a7f3d0',
                'brand_muted_bg_color' => '#f0fdf4',
                'brand_table_head_color' => '#ecfdf5',
                'brand_row_hover_color' => '#f0fdfa',
                'brand_button_text_color' => '#ffffff',
                'admin_sidebar_color' => '#052e2b',
                'admin_header_color' => '#ffffff',
                'admin_surface_color' => '#ffffff',
                'admin_card_border_color' => '#d1fae5',
                'admin_accent_soft_color' => '#fffbeb',
                'admin_primary_soft_color' => '#d1fae5',
                'customer_card_radius' => '20',
                'customer_badge_style' => 'soft',
            ],
            'plum_editorial' => [
                'theme_preset' => 'plum_editorial',
                'theme_label' => 'Plum Editorial',
                'brand_primary_color' => '#7e22ce',
                'brand_secondary_color' => '#3b0764',
                'brand_accent_color' => '#db2777',
                'brand_background_color' => '#faf7fc',
                'brand_surface_color' => '#ffffff',
                'brand_soft_color' => '#f3e8ff',
                'brand_border_color' => '#e9d5ff',
                'brand_muted_bg_color' => '#fdf4ff',
                'brand_table_head_color' => '#faf5ff',
                'brand_row_hover_color' => '#fdf4ff',
                'brand_button_text_color' => '#ffffff',
                'admin_sidebar_color' => '#2e1065',
                'admin_header_color' => '#ffffff',
                'admin_surface_color' => '#ffffff',
                'admin_card_border_color' => '#e9d5ff',
                'admin_accent_soft_color' => '#fce7f3',
                'admin_primary_soft_color' => '#f3e8ff',
                'customer_card_radius' => '24',
                'customer_badge_style' => 'pill',
            ],
            'graphite_modern' => [
