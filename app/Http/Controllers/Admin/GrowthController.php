...
class GrowthController extends Controller
{
    ...
    protected function renderModulePage(string $page): View
    {
        ...
        return view('admin.growth.'.$viewPage, [
            ...
            'campaigns' => $snapshot['campaigns'] ?? collect(),
            'rules' => $snapshot['rules'] ?? collect(),
            'templates' => $snapshot['templates'] ?? collect(),
            'segments' => $snapshot['segments'] ?? collect(),
            'experiments' => $snapshot['experiments'] ?? collect(),
            'deliveries' => $snapshot['deliveries'] ?? collect(),
            'triggerLogs' => $snapshot['trigger_logs'] ?? collect(),
            'messageLogs' => $snapshot['message_logs'] ?? collect(),
            'overviewHealth' => $snapshot['overview_health'] ?? [],
