...
class ContentSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'store_social_facebook' => ['nullable', 'url:http,https', 'max:500'],
            'store_social_instagram' => ['nullable', 'url:http,https', 'max:500'],
            'store_social_tiktok' => ['nullable', 'url:http,https', 'max:500'],
            'store_social_youtube' => ['nullable', 'url:http,https', 'max:500'],
            'store_social_linkedin' => ['nullable', 'url:http,https', 'max:500'],
