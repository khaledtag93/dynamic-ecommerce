...
class ProductForm extends Component
{
    ...
    {
        $this->dispatch('product-form-toast', type: $type, message: $message, duration: $duration);
    }
    ...
    protected function applyOptimisticSaveState(Product $product, bool $wasEditing): void
    {
        ...
        $this->dispatch('product-form-save-succeeded', product_id: $product->id, action: $action, saved_at: now()->format('H:i'));
    ...
    $this->dispatch('product-form-save-failed', message: $firstMessage, messages: $allMessages->toArray());
