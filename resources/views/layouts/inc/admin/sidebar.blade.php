  ...
  @endphp
    ...
    @if($can('dashboard.view'))
        <div class="sidebar-quick-access px-3 pt-3 pb-2">
            <a href="{{ route('admin.dashboard') }}" class="sidebar-quick-chip w-100 {{ $isRoute('admin.dashboard') ? 'active' : '' }}" aria-current="{{ $isRoute('admin.dashboard') ? 'page' : 'false' }}">
                <i class="mdi mdi-view-dashboard-outline"></i><span>{{ __('Admin home') }}</span>
            </a>
        </div>
    @endif
    ...
    <details class="sidebar-group" {{ $overviewOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Overview') }}</span>
                </span>
            </span>
    ...
    <details class="sidebar-group" {{ $catalogOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Catalog') }}</span>
                </span>
            </span>
            <i class="mdi mdi-chevron-down sidebar-group-arrow"></i>
        </summary>
    ...
    <details class="sidebar-group" {{ $operationsOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Operations') }}</span>
                </span>
            </span>
            <i class="mdi mdi-chevron-down sidebar-group-arrow"></i>
        </summary>
    ...
    <details class="sidebar-group" {{ $inventoryOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Inventory & sourcing') }}</span>
                </span>
            </span>
            <i class="mdi mdi-chevron-down sidebar-group-arrow"></i>
        </summary>
    ...
    <details class="sidebar-group" {{ $marketingOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Marketing') }}</span>
                </span>
            </span>
            <i class="mdi mdi-chevron-down sidebar-group-arrow"></i>
        </summary>
    ...
    <details class="sidebar-group" {{ $channelsOpen ? 'open' : '' }}>
        <summary class="sidebar-group-summary">
            <span class="sidebar-group-title-wrap">
                ...
                <span>
                    <span class="sidebar-group-title">{{ __('Channels & setup') }}</span>
                </span>
            </span>
            <i class="mdi mdi-chevron-down sidebar-group-arrow"></i>
        </summary>
