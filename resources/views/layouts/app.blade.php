...
<head>
    ...
    <style>
        ...
        html[dir="rtl"] .lc-order-step { padding-left: 0; padding-right: 3rem; }
        .lc-order-step::before { content: ""; position: absolute; left: 1rem; top: 2rem; bottom: -1.2rem; width: 2px; background: #fde2c3; }
        html[dir="rtl"] .lc-order-step::before { left: auto; right: 1rem; }
        ...
        html[dir="rtl"] .lc-order-step-dot { left: auto; right: 0; }
        ...
        html[dir="ltr"] .retail-quick-tile i { order: 1; }
        html[dir="ltr"] .retail-quick-tile > div { order: 2; }
        ...
        html[dir="rtl"] .retail-quick-tile {
            grid-template-columns: minmax(0, 1fr) 48px;
            text-align: right;
        }
        html[dir="rtl"] .retail-quick-tile i { grid-column: 2; }
        html[dir="rtl"] .retail-quick-tile > div { grid-column: 1; }
        html[dir="ltr"] .retail-quick-tile { text-align: left; }
        @media (max-width: 991.98px) {
            .retail-quick-tile { grid-template-columns: 44px minmax(0, 1fr); }
            html[dir="rtl"] .retail-quick-tile { grid-template-columns: minmax(0, 1fr) 44px; }
        }
