...
<body>
    <div class="error-shell">
        ...
        <p class="error-copy">{{ __('The page you are looking for may have moved, been removed, or is temporarily unavailable.') }}</p>
        <div class="error-actions">
            <a href="{{ url('/') }}" class="error-btn">{{ __('Return to storefront') }}</a>
        </div>
    </div>
</body>
</html>
