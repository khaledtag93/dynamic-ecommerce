...
.gm-toggle-list{display:grid;gap:.75rem}.gm-toggle-row{padding:.8rem .85rem!important;border:1px solid var(--admin-border);border-radius:14px;background:var(--admin-surface-alt);margin:0!important}.gm-module{padding:0;overflow:hidden}.gm-module>summary{list-style:none;display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1rem 1.1rem;cursor:pointer}.gm-module>summary::-webkit-details-marker{display:none}.gm-module>summary:hover{background:var(--admin-surface-alt)}
