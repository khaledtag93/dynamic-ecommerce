...
@section('content')
<style>
.analytics-shell{display:grid;gap:20px}.analytics-card,.analytics-mini,.analytics-chart-card{background:var(--admin-surface);border:1px solid var(--admin-border);border-radius:22px;box-shadow:0 18px 45px rgba(15,23,42,.06)}.analytics-card .card-body,.analytics-chart-card{padding:22px}.analytics-grid-4{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.analytics-mini-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.analytics-mini{padding:16px;border-radius:18px;background:color-mix(in srgb,var(--admin-surface) 92%,var(--admin-bg) 8%);border:1px solid var(--admin-border);height:100%}.analytics-anchor-nav{display:flex;gap:10px;flex-wrap:wrap}.analytics-anchor{display:inline-flex;align-items:center;padding:8px 12px;border-radius:999px;background:var(--admin-surface);border:1px solid var(--admin-border);font-weight:700;color:var(--admin-text);text-decoration:none}.analytics-table{width:100%;border-collapse:collapse}.analytics-table th,.analytics-table td{padding:12px 10px;border-bottom:1px solid var(--admin-border)}.analytics-table th{font-size:.84rem;color:var(--admin-muted);text-transform:uppercase;letter-spacing:.03em;white-space:nowrap}.analytics-chart-grid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:16px;align-items:start}.analytics-svg-wrap{position:relative;width:100%;overflow-x:auto;overflow-y:hidden}.analytics-svg-frame{min-width:520px;width:100%}.analytics-svg{width:100%;height:180px;display:block}.analytics-chart-grid>*{min-width:0}.analytics-gridlines{stroke:rgba(148,163,184,.25);stroke-width:1}.analytics-area.rev{fill:rgba(249,115,22,.12)}.analytics-area.views{fill:rgba(148,163,184,.12)}.analytics-area.pur{fill:rgba(15,23,42,.08)}.analytics-line.rev{fill:none;stroke:#f97316;stroke-width:3}.analytics-line.views{fill:none;stroke:#94a3b8;stroke-width:3}.analytics-line.pur{fill:none;stroke:#0f172a;stroke-width:3}.analytics-axis{display:flex;justify-content:space-between;gap:8px;margin-top:8px;color:#64748b;font-size:.78rem;overflow-x:auto;padding-bottom:2px}.analytics-axis span{flex:0 0 auto;min-width:44px;text-align:center}.analytics-axis.compact span{min-width:64px;font-size:.74rem}.analytics-chart-legend{display:flex;gap:14px;flex-wrap:wrap;margin-bottom:14px}.analytics-chart-legend span{display:inline-flex;align-items:center;gap:8px;color:var(--admin-muted);font-size:.83rem}.analytics-chart-legend i{display:inline-block;width:12px;height:12px;border-radius:999px}.analytics-chart-legend .rev{background:var(--admin-primary)}.analytics-chart-legend .views{background:var(--admin-muted)}.analytics-chart-legend .pur{background:var(--admin-text)}.analytics-list{display:grid;gap:14px}.analytics-row{display:flex;justify-content:space-between;gap:14px;padding:12px 0;border-bottom:1px solid var(--admin-border)}.analytics-row:last-child{border-bottom:none}.analytics-bar-track{height:10px;border-radius:999px;background:color-mix(in srgb,var(--admin-border) 72%,transparent);overflow:hidden}.analytics-bar-fill{height:100%;border-radius:999px;background:linear-gradient(90deg,var(--admin-primary),var(--admin-primary-dark))}.analytics-bar-fill.soft{background:linear-gradient(90deg,color-mix(in srgb,var(--admin-muted) 45%,white),var(--admin-muted))}.analytics-bar-fill.dark{background:linear-gradient(90deg,var(--admin-text),color-mix(in srgb,var(--admin-text) 72%,white))}.analytics-detail-stack{display:grid;gap:12px}@media (max-width: 1400px){.analytics-chart-grid{grid-template-columns:1fr}.analytics-detail-stack{grid-template-columns:repeat(2,minmax(0,1fr));display:grid}}@media (max-width: 1200px){.analytics-grid-4,.analytics-mini-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.analytics-chart-grid,.analytics-detail-stack{grid-template-columns:1fr}}@media (max-width: 768px){.analytics-grid-4,.analytics-mini-grid{grid-template-columns:1fr}.analytics-anchor-nav{flex-wrap:nowrap;overflow-x:auto;padding-bottom:4px;scrollbar-width:thin}.analytics-anchor{flex:0 0 auto}.analytics-card .card-body,.analytics-chart-card{padding:16px}.analytics-svg-frame{min-width:460px}.analytics-row{align-items:flex-start}}
</style>
<x-admin.page-header
