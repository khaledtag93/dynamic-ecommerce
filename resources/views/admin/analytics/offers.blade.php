...
@section('content')
<style>
.analytics-shell{display:grid;gap:20px}.analytics-card,.analytics-mini,.offers-hero,.offers-trend-card,.offers-chart-card{background:var(--admin-surface);border:1px solid var(--admin-border);border-radius:22px;box-shadow:0 18px 45px rgba(15,23,42,.06)}.analytics-card .card-body,.offers-hero,.offers-trend-card,.offers-chart-card{padding:22px}.analytics-table{width:100%;border-collapse:collapse}.analytics-table th,.analytics-table td{padding:12px 10px;border-bottom:1px solid var(--admin-border)}.analytics-table th{font-size:.84rem;color:var(--admin-muted);text-transform:uppercase;letter-spacing:.03em;white-space:nowrap}.analytics-mini{padding:16px;border-radius:18px;background:color-mix(in srgb,var(--admin-surface) 92%,var(--admin-bg) 8%);border:1px solid var(--admin-border);height:100%}.offers-hero{background:linear-gradient(135deg,color-mix(in srgb,var(--admin-primary) 8%,var(--admin-surface)),#ffffff);display:grid;gap:16px}.offers-hero-list{display:grid;gap:10px;margin:0;padding:0;list-style:none}.offers-hero-item{padding:12px 14px;border-radius:16px;background:color-mix(in srgb,var(--admin-surface) 92%,transparent);border:1px solid color-mix(in srgb,var(--admin-primary) 16%,var(--admin-border))}.offers-anchor-nav{display:flex;gap:10px;flex-wrap:wrap}.offers-anchor{display:inline-flex;align-items:center;padding:8px 12px;border-radius:999px;background:var(--admin-surface);border:1px solid var(--admin-border);font-weight:700;color:#334155;text-decoration:none}.offers-trend-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.offers-kicker{font-size:.84rem;color:var(--admin-muted);font-weight:700}.offers-value{font-size:1.55rem;font-weight:800;color:var(--admin-text);margin-top:6px}.offers-help{font-size:.82rem;color:var(--admin-muted);margin-top:6px}.offers-list{display:grid;gap:14px}.offers-row{display:flex;justify-content:space-between;gap:14px;padding:12px 0;border-bottom:1px solid var(--admin-border)}.offers-row:last-child{border-bottom:none}.offers-bar{height:10px;border-radius:999px;background:color-mix(in srgb,var(--admin-border) 70%,transparent);overflow:hidden;margin-top:8px}.offers-bar-fill{height:100%;border-radius:999px;background:linear-gradient(90deg,var(--admin-primary),var(--admin-primary-dark))}.offers-storyboard{display:grid;grid-template-columns:1.15fr .85fr;gap:18px}.offers-story-card{padding:20px;border-radius:22px;background:linear-gradient(135deg,#0f172a,#1e293b);color:#fff;border:1px solid rgba(15,23,42,.08);box-shadow:0 20px 45px rgba(15,23,42,.16)}.offers-story-card .eyebrow{font-size:.78rem;letter-spacing:.08em;text-transform:uppercase;color:rgba(255,255,255,.7)}.offers-story-card .headline{font-size:1.55rem;font-weight:800;margin-top:8px;line-height:1.35}.offers-story-card .subcopy{font-size:.92rem;line-height:1.8;color:rgba(255,255,255,.82);margin-top:10px}.offers-story-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:16px}.offers-story-tile{padding:14px;border-radius:16px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.08)}.offers-lane-card{padding:20px;border-radius:22px;border:1px solid var(--admin-border);background:var(--admin-surface);box-shadow:0 18px 45px rgba(15,23,42,.05)}.offers-lane-list{display:grid;gap:12px}.offers-lane-item{padding:14px 16px;border-radius:16px;background:color-mix(in srgb,var(--admin-surface) 92%,var(--admin-bg) 8%);border:1px solid var(--admin-border)}.offers-lane-item .lane-label{font-size:.78rem;letter-spacing:.08em;text-transform:uppercase;color:var(--admin-muted)}.offers-lane-item .lane-value{font-size:1rem;font-weight:800;color:var(--admin-text);margin-top:5px}.offers-spark-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.offers-spark-card{padding:16px;border-radius:20px;background:var(--admin-surface);border:1px solid var(--admin-border);box-shadow:0 16px 35px rgba(15,23,42,.05)}.offers-chart-grid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(280px,.8fr);gap:16px;align-items:start}.offers-chart-legend{display:flex;gap:14px;flex-wrap:wrap;margin-bottom:14px}.offers-chart-legend span{display:inline-flex;align-items:center;gap:8px;color:var(--admin-muted);font-size:.83rem}.offers-chart-legend i{display:inline-block;width:12px;height:12px;border-radius:999px}.offers-chart-legend .rev{background:var(--admin-primary)}.offers-chart-legend .ord{background:var(--admin-muted)}.offers-svg-wrap{position:relative;width:100%;overflow-x:auto;overflow-y:hidden}.offers-svg-frame{min-width:520px;width:100%}.offers-svg{width:100%;height:220px;display:block}.offers-chart-grid>*{min-width:0}.offers-gridline{stroke:rgba(148,163,184,.25);stroke-width:1}.offers-axis{display:flex;justify-content:space-between;gap:8px;margin-top:8px;color:var(--admin-muted);font-size:.78rem;overflow-x:auto;padding-bottom:2px}.offers-axis span{flex:0 0 auto;min-width:60px;text-align:center}.offers-detail-stack{display:grid;gap:12px}@media (max-width: 1400px){.offers-chart-grid{grid-template-columns:1fr}.offers-detail-stack{grid-template-columns:repeat(2,minmax(0,1fr));display:grid}}@media (max-width: 1200px){.offers-trend-grid,.offers-spark-grid,.offers-story-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.offers-storyboard,.offers-chart-grid,.offers-detail-stack{grid-template-columns:1fr}}@media (max-width: 768px){.offers-trend-grid,.offers-spark-grid,.offers-story-grid{grid-template-columns:1fr}.analytics-card .card-body,.offers-hero,.offers-trend-card,.offers-chart-card,.offers-story-card,.offers-lane-card{padding:16px}.offers-svg-frame{min-width:460px}.offers-row{align-items:flex-start}.offers-axis{scrollbar-width:thin}}
</style>
<x-admin.page-header
