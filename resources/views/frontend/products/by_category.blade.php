...
.quick-view-modal-content{border-radius:1.5rem;overflow:hidden}.quick-view-media-wrap{background:linear-gradient(180deg,color-mix(in srgb,var(--lc-soft) 78%, white),color-mix(in srgb,var(--lc-surface) 96%, transparent));min-height:100%}.quick-view-image{object-fit:contain;min-height:360px;padding:1.25rem}.quick-view-stock{display:inline-flex;align-items:center;gap:.45rem;padding:.55rem .85rem;border-radius:999px;background:color-mix(in srgb,var(--lc-primary) 10%,var(--lc-surface));border:1px solid color-mix(in srgb,var(--lc-primary) 18%,var(--lc-border));font-weight:800;color:var(--lc-primary-dark)}
