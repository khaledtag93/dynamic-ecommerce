...
| Storefront Foundation UX | Working-line source on `v42-clean-baseline`: marketplace-neutral defaults, duplicate-home-shortcut cleanup, real public product search, safe demo-contact scrub, local image fallbacks, checkout payment/toggle consistency, Product Detail gallery semantics, bilingual copy, and focused storefront regression coverage. See [implementation note](STOREFRONT_FOUNDATION_UX_2026-09-24.md). | Branch-head CI pending | Not deployed/visually verified | Not deployed | Verify English/Arabic desktop/mobile Home + Search + missing-image behavior and preserved custom content before promotion. |
