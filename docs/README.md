...
| WhatsApp workspace UX | Working-line source on `v42-clean-baseline`: focused section navigation, aligned toggle cards, shared metric cards, theme-aware settings/test/log workspaces, bilingual labels, and unchanged provider/queue/resend/retry behavior. See [implementation note](WHATSAPP_WORKSPACE_UX_2026-09-24.md). | Branch-head CI pending | Not deployed/visually verified | Not deployed | Verify English/Arabic desktop/mobile layout, save/reload, controlled test/resend/retry and log filtering before promotion. |
| Cost Calculator UX polish | Working-line source on `v42-clean-baseline`: theme-aware workflow styling, section shortcuts, shared cost/profit metric cards, submit-loading, in-app material delete confirmation, bilingual copy, and unchanged calculation formulas. See [implementation note](COST_CALCULATOR_UX_2026-09-24.md). | Branch-head CI pending | Not deployed/visually verified | Not deployed | Verify live calculations, save/delete flows, table overflow and English/Arabic mobile layout before promotion. |
