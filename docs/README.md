...
| Analytics & Insights V2 | Working-line source on `v42-clean-baseline`: shorter decision-first overview, shared admin KPI cards, consolidated trends/funnel/comparison/drilldowns, expandable daily diagnostics, simplified Growth/Offers summary layers, theme-aware Analytics navigation/toolbars/charts and bilingual copy. See [implementation note](ANALYTICS_INSIGHTS_V2_2026-09-24.md). | Branch-head CI pending | Not deployed/visually verified | Not deployed | Verify identical KPI values/ranges, charts, exports, product drilldowns, responsive behavior and Arabic RTL before promotion. |
