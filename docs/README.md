...
| Storefront Foundation UX | Working-line source on `v42-clean-baseline`: marketplace-neutral home/search, local image fallback, checkout/payment signals, product/account polish, safe Paymob result messaging, localized contact hours, cart confirmation, unpublished-safe legal defaults, aligned Store Content switches and bilingual copy. See [implementation note](STOREFRONT_FOUNDATION_UX_2026-09-24.md). | Branch-head CI pending for latest storefront safety commit | Not deployed/visually verified | Not deployed | Verify English/Arabic desktop/mobile Home/Search/Product/Cart/Checkout/Account/Contact/Payment/Legal flows before promotion. |
